...
@section('content')
    <div class="page-content">
        ...
        <h5 class="mb-0 text-uppercase">Users Management</h5>
        <hr />
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.user.show', $user->id) }}" class="ms-1 text-warning"
                                            style="font-size: 24px;"><i class="bx bxs-edit"></i></a>

                                        <a href="{{ route('admin.user.delete', $user->id) }}" class="ms-1 text-danger"
