                            ...
                            @forelse($notifications as $notification)
                                <tr class="{{ $notification->read_at ? '' : 'bg-light-info bg-opacity-25' }}">
                                    ...
                                    <td>
                                        ...
                                        @elseif(isset($notification->data['contact_id']))
                                            New contact form submission from <strong>{{ $notification->data['name'] }}</strong> with subject: 
                                            "<a href="{{ url($notification->data['url']) }}">{{ $notification->data['subject'] }}</a>"
                                        @elseif(isset($notification->data['newsletter_id']))
                                            New newsletter subscription from <strong>{{ $notification->data['email'] }}</strong>
                                        @else
