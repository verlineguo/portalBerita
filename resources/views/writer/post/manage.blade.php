...
@section('content')
    ...
    <div class="page-content">
        ...
        <h5 class="mb-3 text-uppercase">Post Management</h5>

        <div class="ms-auto d-flex mb-3 justify-content-between">
            <!-- Dropdown Filter Role -->
            <form method="GET" action="{{ route('writer.post.manage') }}">
            ...
            <div class="btn-group">
                <a href="{{ route('writer.post.create') }}" class="btn btn-primary">Create</a>
            </div>
        </div>
